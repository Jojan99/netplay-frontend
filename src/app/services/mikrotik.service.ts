...
export class MikrotikService {
  ...
  getLanSegments(): Observable<any> {
    return this.http.get(`${this.base}/getLanSegments`, this.h());
  }

  getIpAvalibles(vlan: string): Observable<any> {
    return this.http.post(`${this.base}/getIpAvalibles`, { vlan }, this.h());
  }
}
