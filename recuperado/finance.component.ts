...
export class FinanceComponent implements OnInit, OnDestroy {
  ...
  confirmPay(): void {
    ...
    this.financeService.payInvoice(this.payingInvoice.id, clientName).subscribe({
      next: (res) => {
        this.payModal = false;
  ...
  confirmAbonar(): void {
    ...
    const clientName = `${this.selectedClient.names} ${this.selectedClient.lastname}`;
    this.financeService.abonarInvoice(this.abonarInvoice.id, this.abonarAmount, clientName).subscribe({
      next: () => {
        this.abonarModal = false;
