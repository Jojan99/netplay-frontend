...
export class EgresosComponent implements OnInit, OnDestroy {
  ...
  form = { concept: '', category: 'General', value: 0 };
  ...
  openCreate(): void {
    ...
    this.editingId  = null;
    this.form       = { concept: '', category: 'General', value: 0 };
    this.modal      = true;
  }
  ...
  openEdit(egreso: any): void {
    ...
    this.form       = { concept: egreso.concept, category: egreso.category || 'General', value: +egreso.value };
    this.modal      = true;
  }
